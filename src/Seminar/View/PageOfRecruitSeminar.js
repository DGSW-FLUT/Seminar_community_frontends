                ...
                <Modal.Body>
                    <Form className="p-4">
                            ...
                            <div className="d-inline-flex">
                                ...
                                <div className="form-check form-check-inline mx-3 mb-3">
                                    <input
                                        ...
                                        ref={this.grade1}
                                    />
                                    <label className="form-check-label" for="inlineCheckbox1" name="tag_kind">
                                        1학년
                                    </label>
                                </div>
                                <div className="form-check form-check-inline mb-3">
                                    <input
                                        ...
                                        ref={this.grade2}
                                    />
                                    <label className="form-check-label" for="inlineCheckbox2" name="tag_kind">
                                        2학년
                                    </label>
                                </div>
                                <div className="form-check form-check-inline mb-3">
                        ...
                        <input
                            ...
                            defaultValue={this.state.Title.replace(/,/gi, '\n')}
                        ></input>
                        <br />
                        <hr />
                        <TextareaAutosize
                    ...
                    <Button
                        onClick={() =>
                            this.Submit({
                                ...
                                timesofclass: this.timesofcount.current.value,
                            })
                        }
                    >
                        작성하기
            ...
            post_view = (
                <div className="my-5 p-5 rounded bg-white shadow-sm container">
                    ...
                    <h1 className=" pb-2 mb-0">
                        ...
                        {this.state.post.postofrecruitseminar.getTags.map((tag) => (
                            <Badge
                                key={tag.id}
                    ...
                    <div
                        ...
                        dangerouslySetInnerHTML={{
                            __html: this.state.post.postofrecruitseminar.content.replace(/,/gi, '<br/>'),
                        }}
                    />
